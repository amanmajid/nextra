...
supply_color_dict     = {'israel_curtailed'             : 'red', 
                         'israel_solar'                 : 'gold', 
                         'israel_coal'                  : 'darkgray', 
                         'israel_natural_gas'           : 'lightslategray', 
                         ...
                         'israel_wind_curtailed'        : 'red', 
                         'israel_wind'                  : 'darkorange',
                         'jordan_curtailed'             : 'red', 
                         'jordan_solar'                 : 'gold', 
                         'jordan_coal'                  : 'darkgray', 
                         'jordan_natural_gas'           : 'lightslategray', 
                         'jordan_ccgt'                  : 'moccasin', 
                         'jordan_shale'                 : 'chocolate', 
                         'jordan_diesel'                : 'darkred', 
                         'jordan_battery_charge'        : 'lightgreen', 
                         'jordan_battery_discharge'     : 'teal', 
                         'jordan_solar_curtailed'       : 'red', 
                         'jordan_wind_curtailed'        : 'red', 
                         'jordan_wind'                  : 'darkorange',
                         'west_bank_curtailed'          : 'red', 
                         'west_bank_solar'              : 'gold', 
                         'west_bank_coal'               : 'darkgray', 
                         'west_bank_natural_gas'        : 'lightslategray', 
                         'west_bank_ccgt'               : 'moccasin', 
                         'west_bank_shale'              : 'chocolate', 
                         'west_bank_diesel'             : 'darkred', 
                         'west_bank_battery_charge'     : 'lightgreen', 
                         'west_bank_battery_discharge'  : 'teal', 
                         'west_bank_solar_curtailed'    : 'red', 
                         'west_bank_wind_curtailed'     : 'red', 
                         'west_bank_wind'               : 'darkorange',
                         'gaza_curtailed'               : 'red', 
                         'gaza_solar'                   : 'gold', 
                         'gaza_coal'                    : 'darkgray', 
                         'gaza_natural_gas'             : 'lightslategray', 
                         'gaza_ccgt'                    : 'moccasin', 
                         'gaza_shale'                   : 'chocolate', 
                         'gaza_diesel'                  : 'darkred', 
                         'gaza_battery_charge'          : 'lightgreen', 
                         'gaza_battery_discharge'       : 'teal', 
                         'gaza_solar_curtailed'         : 'red', 
                         'gaza_wind_curtailed'          : 'red', 
                         'gaza_wind'                    : 'darkorange'}
